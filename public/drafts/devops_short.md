...
Декабрь 2023 — октябрь 2025 (1 год и 10 месяцев)
...
[Oneclick LIFE](https://oneclick.life/) (проект [Looky](https://looky.com/)) (проект [Viory](http://viory.video/))
Senior Software Engineer
Апрель 2022 — декабрь 2023 (1 год 8 месяцев)

Проектировал и разрабатывал критически важные микросервисы, включая сервис авторизации, используемый как основа всей платформы — фокус на высокую доступностью и безопасность.
...
Стек: Ruby, Typescript, Ruby on rails, AWS (more 25+ services), YandexCloud, K8S, terraform, Docker, OpenAPI
